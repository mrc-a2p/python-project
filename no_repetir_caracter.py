...
def first_not_repeatng_char(char_sequence):
    seen_letters = {}
...
if __name__ == '__main__':
    char_sequence = str(raw_input("Escribe una secuencia de caracters: "))

    result = first_not_repeatng_char(char_sequence)

    if result == "_":
        print ("Todos los caracters se repiten")
    else:
